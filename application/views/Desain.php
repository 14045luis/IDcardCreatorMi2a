		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Card Desain </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Pilih Organisasi</h4>
                            </div>
                            <div class="content">
                            <?php 
    $attributes = array('class' => 'form-signin');
        echo form_open('desain/pencarian',$attributes); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control border-input" name="organisasi">
                                                    <?php foreach ($organisasi as $r ) { ?>
                                                        <option value="<?php echo $r->id_organisasi; ?>"><?php echo $r->nama; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="update" class="btn btn-info btn-fill btn-wd">Ganti Desain</button>
                                    </div>
